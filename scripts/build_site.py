...
<a class="{i}" href="index.html">Landscape</a><a class="{h}" href="hub.html">The Machine</a><a class="{g}" href="idea-graph.html">Idea Graph</a><a href="math.html">Mathematics</a><a href="map.html">Field map</a></div>
<main>
"""
FOOT = "</main></body></html>\n"
